...
use App\Http\Controllers\IncrementorController;
...
Route::get('/insert-dummy-data', [IncrementorController::class, 'insertDummyData']);
Route::get('/update-incrementor-values', [IncrementorController::class, 'updateIncrementorValues']);
Route::get('/incrementor', [Gamesetting::class, 'increamentor']);
// In routes/api.php for API routes
Route::get('/incrementor/first-value', [IncrementorController::class, 'getFirstValue']);
