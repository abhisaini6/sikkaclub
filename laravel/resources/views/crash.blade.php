        ...
        <div class="left-sidebar">
            ...
            <div class="contents-blocks">
                <div class="tab-content" id="pills-tabContent">
                    <!-- <div class="tab-pane fade show " id="pills-allbets" role="tabpanel"
                    ...
                    <div class="tab-pane fade active" id="pills-mybets" role="tabpanel" aria-labelledby="pills-mybets-tab">
                        <div class="list-data-tbl mt-2">
                            <div class="list-header">
                                <div class="column-1">
                                    Date
                ...
                <div class="stage-board">
                    ...
                    <div class="loading-game">
                        <div class="center-loading text-white text-center game-centeral-loading">
                            ...
                            <div class="secondary-font f-40 mt-2 waiting-text"> WAITING FOR NEXT ROUND</div>
                            <div class="line-loader mt-2">
                                <div class="fill-line" style="animation: line-fill 12s linear;"></div>
    ...
    function startCountdown() {
        ...
        const countdownInterval = setInterval(() => {
            if (timeLeft > 0) {
                ...
                countdownTimer.textContent = "Game Starting...";
            }
        }, 1000); // Update every second
    }

    // Call the startCountdown function when the new game starts
    startCountdown();
</script>
