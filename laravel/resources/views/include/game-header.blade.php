...
<header>
    <div class="header-top">
        ...
        <div class="header-right d-flex align-items-center">
                ...
                <a href="https://sikkaclubs.com/"><button class="deposite-btn rounded-pill d-flex align-items-center me-2">
                ...
                <button class="deposite-btn rounded-pill d-flex align-items-center me-2">
                    ...
                    <!-- <span>$</span> -->
                    <span class="me-2" id="header_wallet_balance">₹{{ user('money') }}</span>
                    Amount
                </button>
            ...
            <div class="btn-group">
                ...
                <a class="f-12 justify-content-between">
					...
					<li class="divider"> </li>
                        ...
                        <!--</li>-->
                        <li>
                            <a href="https://sikkaclubs.com/" class="f-12 justify-content-between">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined ico f-20">
                                        payments
                                    </span>Home
